    ...
    <div className="min-h-screen bg-gradient-to-br from-[#1E2A5A] to-[#0A122E] text-white flex flex-col items-center justify-center p-4">
      ...
      <div className="flex flex-col items-center mb-12">
        ...
        <p className="text-lg text-gray-300 text-center px-4">
          Enter your information to access as Staff
        </p>
      </div>

      {/* Staff Login Form */}
      <form onSubmit={handleStaffLogin} className="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center text-center max-w-sm w-full">
