...
const ResidentLoginTemp = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1E2A5A] to-[#0A122E] text-white flex flex-col items-center justify-center p-4">
      ...
      {/* Resident Login Form */}
      <form onSubmit={handleResidentLogin} className="bg-white p-8 rounded-xl shadow-lg flex flex-col items-center text-center max-w-sm w-full">
...
export default ResidentLoginTemp; 